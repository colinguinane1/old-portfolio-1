...
function Index() {
    ...
    return (
        <div className={`${darkMode ? "dark" : ""}`}>        
            ...
            <motion.div initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} className='no_transition' transition={{ delay: 0.2 }}> {/* Animate LandingCard */}
                <LandingCard />
            </motion.div>
            <motion.div initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} className='no_transition' transition={{ delay: 0.5 }}> {/* Animate TechStack */}
                <TechStack />
            </motion.div>
            <Footer />
            <motion.div
