    ...
    <main className='flex flex-col items-center h-screen mx-5'>
      <div className='border rounded-md shadow-md border-white dark:border-[#31363F] dark:bg-[#31363F] w-fit p-10 mt-20 flex flex-col md:flex-row items-center'>
        <div className='order-2 md:order-1 md:text-left md:mr-4 mb-4 md:mb-0'>
          ...
          <button className='border-4 border-black dark:border-white dark:bg-white rounded-lg flex text-center svg_hover' onClick={() => window.location.href = 'https://github.com/colinguinane1'}><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github-filled" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
