    ...
    <main className="flex flex-col items-center h-fit pb-10 mx-5">
      <div className="border rounded-md shadow-lg border-white dark:border-[#31363F] dark:bg-[#31363F] w-fit max-w-5xl p-10 mt-24 flex flex-col md:flex-row items-center">
        <div className="order-2 md:order-1 md:text-left md:mr-4 mb-4 md:mb-0">
          ...
          <br></br>
          <p className="lg:max-w-5xl dark:text-white">
            I&apos;m a passionate front-end developer who loves creating
            responsive web designs and solving problems.
          </p>
          <br></br>
          <div className="flex max-h-10">
            <button
              className="mt-1 rounded-lg flex text-center svg_hover"
              onClick={() =>
                (window.location.href = "https://github.com/colinguinane1")
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="icon icon-tabler icon-tabler-brand-github-filled dark:stroke-white"
                width="35"
                height="35"
                viewBox="0 0 24 24"
                stroke-width="1.5"
            ...
            <button
              onClick={() =>
                (window.location.href =
                  "https://linkedin.com/in/colinguinaneCA")
              }
              className="-mt-[7.5px] svg_hover rotate_up px-0 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
