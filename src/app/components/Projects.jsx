        ...
        <div className="dark:bg-[#31363F] bg-white dark:border-[#31363F] border-gray shadow-lg p-3 rounded-md">
          <div className="px-5 py-3 ">
            ...
            <div className="flex flex-wrap justify-center py-20">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-backhoe stroke-yellow-500" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<h1 className="dark:text-white font-bold px-2 mt-2">Under Construction</h1>
            </div>
          </div>
        </div>
      </div>
